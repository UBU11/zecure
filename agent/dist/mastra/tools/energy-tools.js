...
function getSupabase() {
    if (!_supabase) {
        ...
        if (!url)
            throw new Error('[energy-tools] SUPABASE_URL is not set. Check your .env file.');
        if (!key)
            throw new Error('[energy-tools] SUPABASE_KEY (or SUPABASE_API) is not set. Check your .env file.');
