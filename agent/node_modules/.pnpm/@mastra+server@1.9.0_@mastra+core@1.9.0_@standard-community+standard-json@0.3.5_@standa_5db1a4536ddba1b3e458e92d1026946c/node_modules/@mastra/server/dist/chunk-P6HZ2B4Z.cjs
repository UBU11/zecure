...
var LIST_SCORERS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/scores/scorers",
  responseType: "json",
...
var GET_SCORER_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var LIST_SCORES_BY_RUN_ID_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/scores/run/:runId",
  responseType: "json",
  pathParamSchema: chunkRWLJZWDL_cjs.runIdSchema,
...
var LIST_SCORES_BY_SCORER_ID_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var LIST_SCORES_BY_ENTITY_ID_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  ...
  handler: async ({ mastra, entityId, entityType, ...params }) => {
    try {
      ...
      if (entityType === "AGENT") {
        const agent = await chunkOMLZSETB_cjs.getAgentFromSystem({ mastra, agentId: entityId });
...
var SAVE_SCORE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/scores",
  responseType: "json",
...
//# sourceMappingURL=chunk-P6HZ2B4Z.cjs.map
//# sourceMappingURL=chunk-P6HZ2B4Z.cjs.map