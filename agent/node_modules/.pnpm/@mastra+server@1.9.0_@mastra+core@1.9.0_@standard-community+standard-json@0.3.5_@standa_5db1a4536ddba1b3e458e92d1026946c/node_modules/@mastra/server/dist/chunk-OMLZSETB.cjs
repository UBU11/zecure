...
var chunkBRWU3WHU_cjs = require('./chunk-BRWU3WHU.cjs');
...
function isProviderConnected(providerId) {
  ...
  if (!provider && !cleanId.includes("/")) {
    const registryKeys = Object.keys(llm.PROVIDER_REGISTRY);
    const matchingKey = registryKeys.find((key) => {
      const parts = key.split("/");
      return parts.length === 2 && parts[1] === cleanId;
    });
    if (matchingKey) {
      provider = llm.PROVIDER_REGISTRY[matchingKey];
    }
  }
      ...
      try {
        if (tool.inputSchema) {
          if (tool.inputSchema && typeof tool.inputSchema === "object" && "jsonSchema" in tool.inputSchema) {
            inputSchemaForReturn = chunkHHE6BWUK_cjs.stringify(tool.inputSchema.jsonSchema);
          } else if (typeof tool.inputSchema === "function") {
            const inputSchema = tool.inputSchema();
            if (inputSchema && inputSchema.jsonSchema) {
              inputSchemaForReturn = chunkHHE6BWUK_cjs.stringify(inputSchema.jsonSchema);
            }
          } else if (tool.inputSchema) {
            inputSchemaForReturn = chunkHHE6BWUK_cjs.stringify(
        ...
        if (tool.outputSchema) {
          if (tool.outputSchema && typeof tool.outputSchema === "object" && "jsonSchema" in tool.outputSchema) {
            outputSchemaForReturn = chunkHHE6BWUK_cjs.stringify(tool.outputSchema.jsonSchema);
          } else if (typeof tool.outputSchema === "function") {
            const outputSchema = tool.outputSchema();
            if (outputSchema && outputSchema.jsonSchema) {
              outputSchemaForReturn = chunkHHE6BWUK_cjs.stringify(outputSchema.jsonSchema);
            }
          } else if (tool.outputSchema) {
            outputSchemaForReturn = chunkHHE6BWUK_cjs.stringify(
        ...
        if (tool.requestContextSchema) {
          if (tool.requestContextSchema && typeof tool.requestContextSchema === "object" && "jsonSchema" in tool.requestContextSchema) {
            requestContextSchemaForReturn = chunkHHE6BWUK_cjs.stringify(tool.requestContextSchema.jsonSchema);
            ...
            if (requestContextSchema && requestContextSchema.jsonSchema) {
              requestContextSchemaForReturn = chunkHHE6BWUK_cjs.stringify(requestContextSchema.jsonSchema);
            }
          } else if (tool.requestContextSchema) {
            requestContextSchemaForReturn = chunkHHE6BWUK_cjs.stringify(
...
async function formatAgentList({
  ...
  if (agent.requestContextSchema) {
    try {
      serializedRequestContextSchema = chunkHHE6BWUK_cjs.stringify(zodToJson.zodToJsonSchema(agent.requestContextSchema));
    } catch (error) {
...
var LIST_AGENTS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/agents",
  responseType: "json",
  ...
  responseSchema: chunkWAQHLUSX_cjs.listAgentsResponseSchema,
...
var GET_AGENT_BY_ID_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/agents/:agentId",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  responseSchema: chunkWAQHLUSX_cjs.serializedAgentSchema,
...
var CLONE_AGENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/clone",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: zod.z.object({
    newId: zod.z.string().optional().describe("ID for the cloned agent. If not provided, derived from agent ID."),
    newName: zod.z.string().optional().describe('Name for the cloned agent. Defaults to "{name} (Clone)".'),
  ...
  handler: async ({ agentId, mastra, newId, newName, metadata, authorId, requestContext }) => {
    try {
      const editor = mastra.getEditor();
      if (!editor) {
        return chunkSUKFO7UM_cjs.handleError(new Error("Editor is not configured on the Mastra instance"), "Error cloning agent");
      }
      const agent = await getAgentFromSystem({ mastra, agentId });
      const cloneId = chunkHHE6BWUK_cjs.toSlug(newId || `${agentId}-clone`);
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error cloning agent");
    }
  }
});
var GENERATE_AGENT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/generate",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.agentExecutionBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.generateResponseSchema,
...
var GENERATE_LEGACY_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/generate-legacy",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.agentExecutionLegacyBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.generateResponseSchema,
...
var STREAM_GENERATE_LEGACY_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/stream-legacy",
  responseType: "datastream-response",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.agentExecutionLegacyBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.streamResponseSchema,
...
var GET_PROVIDERS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/agents/providers",
  responseType: "json",
  responseSchema: chunkWAQHLUSX_cjs.providersResponseSchema,
...
var GENERATE_AGENT_VNEXT_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var STREAM_GENERATE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var STREAM_GENERATE_VNEXT_DEPRECATED_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var APPROVE_TOOL_CALL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/approve-tool-call",
  responseType: "stream",
  streamFormat: "sse",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.approveToolCallBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.toolCallResponseSchema,
...
var DECLINE_TOOL_CALL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/decline-tool-call",
  responseType: "stream",
  streamFormat: "sse",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.declineToolCallBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.toolCallResponseSchema,
...
var APPROVE_TOOL_CALL_GENERATE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var DECLINE_TOOL_CALL_GENERATE_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var STREAM_NETWORK_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var APPROVE_NETWORK_TOOL_CALL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/approve-network-tool-call",
  responseType: "stream",
  streamFormat: "sse",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.approveNetworkToolCallBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.streamResponseSchema,
...
var DECLINE_NETWORK_TOOL_CALL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/decline-network-tool-call",
  responseType: "stream",
  streamFormat: "sse",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.declineNetworkToolCallBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.streamResponseSchema,
...
var UPDATE_AGENT_MODEL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/model",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.updateAgentModelBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.modelManagementResponseSchema,
...
var RESET_AGENT_MODEL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var REORDER_AGENT_MODEL_LIST_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/models/reorder",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.reorderAgentModelListBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.modelManagementResponseSchema,
...
var UPDATE_AGENT_MODEL_IN_MODEL_LIST_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/models/:modelConfigId",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.modelConfigIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.updateAgentModelInModelListBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.modelManagementResponseSchema,
...
var ENHANCE_INSTRUCTIONS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/instructions/enhance",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.enhanceInstructionsBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.enhanceInstructionsResponseSchema,
...
${comment ? `User feedback: ${comment}` : ""}`,
        {
          structuredOutput: {
            schema: chunkWAQHLUSX_cjs.enhanceInstructionsResponseSchema
          }
        }
      );
...
var STREAM_VNEXT_DEPRECATED_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var STREAM_UI_MESSAGE_VNEXT_DEPRECATED_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var STREAM_UI_MESSAGE_DEPRECATED_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var GET_AGENT_SKILL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/agents/:agentId/skills/:skillName",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentSkillPathParams,
  responseSchema: chunkBRWU3WHU_cjs.getAgentSkillResponseSchema,
...
exports.CLONE_AGENT_ROUTE = CLONE_AGENT_ROUTE;
...
//# sourceMappingURL=chunk-OMLZSETB.cjs.map
//# sourceMappingURL=chunk-OMLZSETB.cjs.map