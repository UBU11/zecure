...
async function getAgentCardByIdHandler({
  ...
  const agentCard = {
    ...
    description: chunkHHE6BWUK_cjs.convertInstructionsToString(instructions),
    url: executionUrl,
    provider,
    version,
    capabilities: {
...
var GET_AGENT_CARD_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var AGENT_EXECUTION_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/a2a/:agentId",
  responseType: "json",
  pathParamSchema: a2aAgentIdPathParams,
...
//# sourceMappingURL=chunk-YMHD5QN4.cjs.map
//# sourceMappingURL=chunk-YMHD5QN4.cjs.map