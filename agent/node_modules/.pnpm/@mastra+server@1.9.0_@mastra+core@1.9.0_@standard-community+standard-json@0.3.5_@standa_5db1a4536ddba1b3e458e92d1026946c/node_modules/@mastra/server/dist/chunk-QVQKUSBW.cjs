...
var GET_SPEAKERS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/agents/:agentId/voice/speakers",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  responseSchema: chunkWAQHLUSX_cjs.voiceSpeakersResponseSchema,
  ...
  handler: async ({ mastra, agentId, requestContext }) => {
    try {
      ...
      const agent = await chunkOMLZSETB_cjs.getAgentFromSystem({ mastra, agentId });
...
var GET_SPEAKERS_DEPRECATED_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var GENERATE_SPEECH_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/voice/speak",
  responseType: "stream",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.generateSpeechBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.speakResponseSchema,
...
var GENERATE_SPEECH_DEPRECATED_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var TRANSCRIBE_SPEECH_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
  path: "/agents/:agentId/voice/listen",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  bodySchema: chunkWAQHLUSX_cjs.transcribeSpeechBodySchema,
  responseSchema: chunkWAQHLUSX_cjs.transcribeSpeechResponseSchema,
...
var TRANSCRIBE_SPEECH_DEPRECATED_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var GET_LISTENER_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/agents/:agentId/voice/listener",
  responseType: "json",
  pathParamSchema: chunkWAQHLUSX_cjs.agentIdPathParams,
  responseSchema: chunkWAQHLUSX_cjs.getListenerResponseSchema,
...
//# sourceMappingURL=chunk-QVQKUSBW.cjs.map
//# sourceMappingURL=chunk-QVQKUSBW.cjs.map