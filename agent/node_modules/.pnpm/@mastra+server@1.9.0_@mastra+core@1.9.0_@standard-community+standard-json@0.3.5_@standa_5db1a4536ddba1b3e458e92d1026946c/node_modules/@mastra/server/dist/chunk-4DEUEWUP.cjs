...
var LIST_TOOLS_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/tools",
  responseType: "json",
...
var GET_TOOL_BY_ID_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
  path: "/tools/:toolId",
  responseType: "json",
...
var EXECUTE_TOOL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
var GET_AGENT_TOOL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "GET",
...
var EXECUTE_AGENT_TOOL_ROUTE = chunkK52BGIHQ_cjs.createRoute({
  method: "POST",
...
//# sourceMappingURL=chunk-4DEUEWUP.cjs.map
//# sourceMappingURL=chunk-4DEUEWUP.cjs.map