      ...
      configureMastraToolingForAgents: async () => {
        ...
        if (choice === "skills") {
          ...
          const initialSelection = await p.multiselect({
            message: `Select agent(s) to install skills for ${color2.dim("(use arrow keys / space bar)")}`,
...
var createMastraProject = async ({
  ...
  "include": [
    ...
    try {
      ...
      await exec3(`echo *.db-* >> .gitignore`);
      await exec3(`echo .netlify >> .gitignore`);
      await exec3(`echo .vercel >> .gitignore`);
    } catch (error) {
...
//# sourceMappingURL=chunk-HFOAKEDF.js.map
//# sourceMappingURL=chunk-HFOAKEDF.js.map