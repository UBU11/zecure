...
var require_secure_json_parse = __commonJS3({
  "../../../node_modules/.pnpm/secure-json-parse@2.7.0/node_modules/secure-json-parse/index.js"(exports$1, module) {
    ...
    function safeParse(text4, reviver) {
      ...
      Error.stackTraceLimit = 0;
      try {
        return _parse3(text4, reviver, { safe: true });
      } catch (_e) {
        return null;
      } finally {
        Error.stackTraceLimit = stackTraceLimit;
...
var jsonValueSchema2 = z4.z.lazy(
  () => z4.z.union([
    ...
    z4.z.number(),
    z4.z.boolean(),
    z4.z.record(z4.z.string(), jsonValueSchema2),
    z4.z.array(jsonValueSchema2)
  ])
);
var providerMetadataSchema2 = z4.z.record(
  z4.z.string(),
  z4.z.record(z4.z.string(), jsonValueSchema2)
);
var textPartSchema2 = z4.z.object({
  type: z4.z.literal("text"),
  text: z4.z.string(),
  providerOptions: providerMetadataSchema2.optional()
});
var imagePartSchema2 = z4.z.object({
  type: z4.z.literal("image"),
  image: z4.z.union([dataContentSchema2, z4.z.instanceof(URL)]),
  mediaType: z4.z.string().optional(),
  providerOptions: providerMetadataSchema2.optional()
});
var filePartSchema2 = z4.z.object({
  type: z4.z.literal("file"),
  data: z4.z.union([dataContentSchema2, z4.z.instanceof(URL)]),
  filename: z4.z.string().optional(),
  mediaType: z4.z.string(),
  providerOptions: providerMetadataSchema2.optional()
});
var reasoningPartSchema2 = z4.z.object({
  type: z4.z.literal("reasoning"),
  text: z4.z.string(),
  providerOptions: providerMetadataSchema2.optional()
});
var toolCallPartSchema2 = z4.z.object({
...
var toolResultPartSchema2 = z4.z.object({
...
var userModelMessageSchema = z4.z.object({
  ...
  content: z4.z.union([
    z4.z.string(),
    z4.z.array(z4.z.union([textPartSchema2, imagePartSchema2, filePartSchema2]))
  ]),
  providerOptions: providerMetadataSchema2.optional()
});
...
var toolModelMessageSchema = z4.z.object({
  ...
  content: z4.z.array(toolResultPartSchema2),
  providerOptions: providerMetadataSchema2.optional()
});
z4.z.union([
...
async function parsePartialJson2(jsonText) {
  ...
  result = await safeParseJSON2({ text: fixJson2(jsonText) });
  if (result.success) {
    return { value: result.value, state: "repaired-parse" };
  }
  return { value: void 0, state: "failed-parse" };
  ...
  async doGenerate(options) {
    ...
    try {
      const {
        ...
        body: args,
        successfulResponseHandler: createJsonResponseHandler2(z4.z.any()),
        failedResponseHandler: createJsonErrorResponseHandler2({
          errorSchema: z4.z.any(),
          errorToMessage: (data) => data
        }),
  ...
  async doStream(options) {
    ...
    try {
      const { value: response, responseHeaders } = await postJsonToApi2({
        ...
        body: args,
        successfulResponseHandler: createEventSourceResponseHandler2(z4.z.any()),
        failedResponseHandler: createJsonErrorResponseHandler2({
          errorSchema: z4.z.any(),
          errorToMessage: (data) => data
        }),
...
var jsonValueSchema3 = z4.z.lazy(
  () => z4.z.union([
    z4.z.null(),
    z4.z.string(),
    z4.z.number(),
    z4.z.boolean(),
    z4.z.record(z4.z.string(), jsonValueSchema3.optional()),
    z4.z.array(jsonValueSchema3)
  ])
);
var providerMetadataSchema3 = z4.z.record(
  z4.z.string(),
  z4.z.record(z4.z.string(), jsonValueSchema3.optional())
);
var textPartSchema3 = z4.z.object({
  type: z4.z.literal("text"),
  text: z4.z.string(),
  providerOptions: providerMetadataSchema3.optional()
});
var imagePartSchema3 = z4.z.object({
  type: z4.z.literal("image"),
  image: z4.z.union([dataContentSchema3, z4.z.instanceof(URL)]),
  mediaType: z4.z.string().optional(),
  providerOptions: providerMetadataSchema3.optional()
});
var filePartSchema3 = z4.z.object({
  type: z4.z.literal("file"),
  data: z4.z.union([dataContentSchema3, z4.z.instanceof(URL)]),
  filename: z4.z.string().optional(),
  mediaType: z4.z.string(),
  providerOptions: providerMetadataSchema3.optional()
});
var reasoningPartSchema3 = z4.z.object({
  type: z4.z.literal("reasoning"),
  text: z4.z.string(),
  providerOptions: providerMetadataSchema3.optional()
});
var toolCallPartSchema3 = z4.z.object({
  type: z4.z.literal("tool-call"),
  toolCallId: z4.z.string(),
  toolName: z4.z.string(),
  input: z4.z.unknown(),
...
var outputSchema2 = z4.z.discriminatedUnion(
  "type",
  [
    z4.z.object({
      type: z4.z.literal("text"),
...
var toolResultPartSchema3 = z4.z.object({
  type: z4.z.literal("tool-result"),
  toolCallId: z4.z.string(),
  toolName: z4.z.string(),
...
var systemModelMessageSchema2 = z4.z.object(
  {
    role: z4.z.literal("system"),
    content: z4.z.string(),
    providerOptions: providerMetadataSchema3.optional()
...
var userModelMessageSchema2 = z4.z.object({
  role: z4.z.literal("user"),
  content: z4.z.union([
    z4.z.string(),
    z4.z.array(z4.z.union([textPartSchema3, imagePartSchema3, filePartSchema3]))
  ]),
  providerOptions: providerMetadataSchema3.optional()
});
var assistantModelMessageSchema2 = z4.z.object({
  role: z4.z.literal("assistant"),
  content: z4.z.union([
    z4.z.string(),
    z4.z.array(
...
var toolModelMessageSchema2 = z4.z.object({
  role: z4.z.literal("tool"),
  content: z4.z.array(z4.z.union([toolResultPartSchema3, toolApprovalResponseSchema])),
  providerOptions: providerMetadataSchema3.optional()
});
z4.z.union([
...
${workingMemory}`;
    ...
    if (Array.isArray(newMessage.content?.parts)) {
      newMessage.content.parts = newMessage.content.parts.filter((part) => {
        ...
        if (part?.type === "text") {
          ...
          return {
            ...part,
            text: memory.removeWorkingMemoryTags(text4).trim()
          };
        }
        return part;
      });
  ...
  parseWorkingMemory(text4) {
    ...
    const content = memory.extractWorkingMemoryContent(text4);
