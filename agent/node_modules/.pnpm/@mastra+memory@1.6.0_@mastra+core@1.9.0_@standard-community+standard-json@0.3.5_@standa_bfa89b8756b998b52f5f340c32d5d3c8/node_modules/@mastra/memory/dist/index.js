    ...
    z$1.object({
      models: z$1.array(
        z$1.object({
          ...
          specification: z$1.object({
            specificationVersion: z$1.literal("v3"),
            provider: z$1.string(),
            modelId: z$1.string()
          }),
  ...
  async doGenerate(options) {
    ...
    try {
      const {
        ...
        body: args,
        successfulResponseHandler: createJsonResponseHandler2(z$1.any()),
        failedResponseHandler: createJsonErrorResponseHandler2({
          errorSchema: z$1.any(),
          errorToMessage: (data) => data
        }),
  ...
  async doStream(options) {
    ...
    try {
      const { value: response, responseHeaders } = await postJsonToApi2({
        ...
        body: args,
        successfulResponseHandler: createEventSourceResponseHandler2(z$1.any()),
        failedResponseHandler: createJsonErrorResponseHandler2({
          errorSchema: z$1.any(),
          errorToMessage: (data) => data
        }),
...
var jsonValueSchema3 = z$1.lazy(
  () => z$1.union([
    ...
    z$1.number(),
    z$1.boolean(),
    z$1.record(z$1.string(), jsonValueSchema3.optional()),
...
var outputSchema2 = z$1.discriminatedUnion(
  "type",
  [
    z$1.object({
      type: z$1.literal("text"),
    ...
    z$1.object({
      type: z$1.literal("execution-denied"),
    ...
    z$1.object({
      ...
      value: z$1.array(
        z$1.union([
          ...
          z$1.object({
            type: z$1.literal("file-url"),
            url: z$1.string(),
            providerOptions: providerMetadataSchema3.optional()
          }),
          z$1.object({
            type: z$1.literal("file-id"),
            fileId: z$1.union([z$1.string(), z$1.record(z$1.string(), z$1.string())]),
            providerOptions: providerMetadataSchema3.optional()
          }),
          z$1.object({
            type: z$1.literal("image-data"),
            data: z$1.string(),
            mediaType: z$1.string(),
            providerOptions: providerMetadataSchema3.optional()
          }),
          z$1.object({
            type: z$1.literal("image-url"),
            url: z$1.string(),
            providerOptions: providerMetadataSchema3.optional()
          }),
          z$1.object({
            type: z$1.literal("image-file-id"),
            fileId: z$1.union([z$1.string(), z$1.record(z$1.string(), z$1.string())]),
            providerOptions: providerMetadataSchema3.optional()
          }),
          z$1.object({
...
var toolApprovalRequestSchema = z$1.object({
  type: z$1.literal("tool-approval-request"),
  approvalId: z$1.string(),
  toolCallId: z$1.string()
});
var toolApprovalResponseSchema = z$1.object({
  type: z$1.literal("tool-approval-response"),
  approvalId: z$1.string(),
...
var toolModelMessageSchema2 = z$1.object({
  role: z$1.literal("tool"),
  content: z$1.array(z$1.union([toolResultPartSchema3, toolApprovalResponseSchema])),
  providerOptions: providerMetadataSchema3.optional()
});
z$1.union([
