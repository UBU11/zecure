import { Mastra } from '../chunk-5M3RMO7U.js';
import { Agent } from '../chunk-MVYP55NA.js';
import { Workspace } from '../chunk-SEKQJ447.js';
...
var Harness = class {
  ...
  async getCurrentModelAuthStatus() {
    ...
    try {
      const { PROVIDER_REGISTRY } = await import('../provider-registry-K3DWQSMH.js');
