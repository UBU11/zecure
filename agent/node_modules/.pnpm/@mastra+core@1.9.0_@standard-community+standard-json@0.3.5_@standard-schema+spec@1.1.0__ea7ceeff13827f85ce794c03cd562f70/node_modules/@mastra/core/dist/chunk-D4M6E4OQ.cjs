...
function getPackageRoot() {
  try {
    const require2 = module$1.createRequire((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('chunk-D4M6E4OQ.cjs', document.baseURI).href)) || "file://");
...
var GatewayRegistry = class _GatewayRegistry {
  ...
  async syncGateways(forceRefresh = false, writeToSrc = false) {
    ...
    try {
      const { ModelsDevGateway } = await import('./models-dev-UVWCKPA2.cjs');
      const { NetlifyGateway } = await import('./netlify-XZAN67PG.cjs');
...
//# sourceMappingURL=chunk-D4M6E4OQ.cjs.map
//# sourceMappingURL=chunk-D4M6E4OQ.cjs.map