...
import type { ProcessorPhase } from '../processor-provider/index.js';
...
export type ProcessorGraphEntryDepth3 = {
    type: 'step';
...
export type ProcessorGraphEntryDepth2 = {
    ...
    type: 'parallel';
    branches: ProcessorGraphEntryDepth3[][];
} | {
    type: 'conditional';
    conditions: ProcessorGraphConditionDepth2[];
};
...
export type ProcessorGraphEntry = {
    ...
    type: 'parallel';
    branches: ProcessorGraphEntryDepth2[][];
} | {
    type: 'conditional';
 ...
 */
export type StorageResolvedMCPServerType = StorageMCPServerType & StorageMCPServerSnapshotType & {
    resolvedVersionId?: string;
};
/**
