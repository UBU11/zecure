...
var MastraLLMV1 = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  async __text({
    ...
    if (experimental_output) {
      ...
      if (chunkQNXY3J6B_cjs.isZodType(experimental_output)) {
    ...
    try {
      const result = await chunk4UOWNFAL_cjs.executeWithContext({
        span: llmSpan,
  ...
  __stream({
    ...
    try {
      return chunk4UOWNFAL_cjs.executeWithContextSync({ span: llmSpan, fn: () => chunkCC3OOESY_cjs.streamText(argsForExecute) });
    } catch (e) {
      const mastraError = new chunk4U7ZLI36_cjs.MastraError(
        {
...
//# sourceMappingURL=chunk-PKORY4ZZ.cjs.map
//# sourceMappingURL=chunk-PKORY4ZZ.cjs.map