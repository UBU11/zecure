...
var chunkCSHG5LWU_cjs = require('./chunk-CSHG5LWU.cjs');
var chunkH5S4PS44_cjs = require('./chunk-H5S4PS44.cjs');
...
function createCerebras(options = {}) {
  var _a15;
  const baseURL = chunkCSHG5LWU_cjs.withoutTrailingSlash(
    (_a15 = options.baseURL) != null ? _a15 : "https://api.cerebras.ai/v1"
  );
  const getHeaders = () => chunkCSHG5LWU_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkCSHG5LWU_cjs.loadApiKey({
  ...
  const createLanguageModel = (modelId) => {
    return new chunkCSHG5LWU_cjs.OpenAICompatibleChatLanguageModel(modelId, {
  ...
  provider.textEmbeddingModel = (modelId) => {
    throw new chunkCSHG5LWU_cjs.NoSuchModelError({ modelId, modelType: "textEmbeddingModel" });
  };
  provider.imageModel = (modelId) => {
    throw new chunkCSHG5LWU_cjs.NoSuchModelError({ modelId, modelType: "imageModel" });
  };
  return provider;
}
createCerebras();
var DeepInfraImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunkCSHG5LWU_cjs.postJsonToApi({
      url: `${this.config.baseURL}/${this.modelId}`,
      headers: chunkCSHG5LWU_cjs.combineHeaders(this.config.headers(), headers),
      body: {
        prompt,
        num_images: n,
      ...
      failedResponseHandler: chunkCSHG5LWU_cjs.createJsonErrorResponseHandler({
        errorSchema: deepInfraErrorSchema,
        errorToMessage: (error) => error.detail.error
      }),
      successfulResponseHandler: chunkCSHG5LWU_cjs.createJsonResponseHandler(
...
var DeepInfraChatLanguageModel = class extends chunkCSHG5LWU_cjs.OpenAICompatibleChatLanguageModel {
  constructor(modelId, config) {
...
function createDeepInfra(options = {}) {
  ...
  const createCompletionModel = (modelId) => new chunkCSHG5LWU_cjs.OpenAICompatibleCompletionLanguageModel(
    modelId,
    getCommonModelConfig("completion")
  );
  const createTextEmbeddingModel = (modelId) => new chunkCSHG5LWU_cjs.OpenAICompatibleEmbeddingModel(
    modelId,
...
var deepseekChatChunkSchema = chunkCSHG5LWU_cjs.lazySchema(
  () => chunkCSHG5LWU_cjs.zodSchema(
    v4.z.union([
      v4.z.object({
        id: v4.z.string().nullish(),
        created: v4.z.number().nullish(),
...
function prepareTools({
  ...
  switch (type) {
    ...
    default: {
      ...
      throw new chunkCSHG5LWU_cjs.UnsupportedFunctionalityError({
...
var DeepSeekChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.failedResponseHandler = chunkCSHG5LWU_cjs.createJsonErrorResponseHandler({
  ...
  async getArgs({
    ...
    var _a15, _b;
    const deepseekOptions = (_a15 = await chunkCSHG5LWU_cjs.parseProviderOptions({
  ...
  async doGenerate(options) {
    ...
    } = await chunkCSHG5LWU_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      headers: chunkCSHG5LWU_cjs.combineHeaders(this.config.headers(), options.headers),
      body: args,
    ...
    if (choice.message.tool_calls != null) {
      for (const toolCall of choice.message.tool_calls) {
        content.push({
          type: "tool-call",
          toolCallId: (_a15 = toolCall.id) != null ? _a15 : chunkCSHG5LWU_cjs.generateId(),
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkCSHG5LWU_cjs.postJsonToApi({
      url: this.config.url({
        path: "/chat/completions",
        modelId: this.modelId
      }),
      ...
      body,
      failedResponseHandler: this.failedResponseHandler,
      successfulResponseHandler: chunkCSHG5LWU_cjs.createEventSourceResponseHandler(
              ...
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  if (toolCallDelta.id == null) {
                    throw new chunkCSHG5LWU_cjs.InvalidResponseDataError({
                      data: toolCallDelta,
                  ...
                  if (((_c = toolCall2.function) == null ? void 0 : _c.name) != null && ((_d = toolCall2.function) == null ? void 0 : _d.arguments) != null) {
                    ...
                    if (chunkCSHG5LWU_cjs.isParsableJson(toolCall2.function.arguments)) {
                      controller.enqueue({
                        type: "tool-input-end",
                        id: toolCall2.id
                      });
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_e = toolCall2.id) != null ? _e : chunkCSHG5LWU_cjs.generateId(),
                ...
                if (((_j = toolCall.function) == null ? void 0 : _j.name) != null && ((_k = toolCall.function) == null ? void 0 : _k.arguments) != null && chunkCSHG5LWU_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_l = toolCall.id) != null ? _l : chunkCSHG5LWU_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
            ...
            switch (part.type) {
              ...
              case "file": {
                ...
                return {
                  type: "image_url",
                  image_url: {
                    url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkCSHG5LWU_cjs.convertToBase64(part.data)}`
                  }
                };
              }
            }
...
var groqFailedResponseHandler = chunkCSHG5LWU_cjs.createJsonErrorResponseHandler({
...
var GroqChatLanguageModel = class {
  ...
  async getArgs({
    ...
    var _a15, _b;
    const warnings = [];
    const groqOptions = await chunkCSHG5LWU_cjs.parseProviderOptions({
      provider: "groq",
      providerOptions,
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkCSHG5LWU_cjs.postJsonToApi({
      ...
      failedResponseHandler: groqFailedResponseHandler,
      successfulResponseHandler: chunkCSHG5LWU_cjs.createEventSourceResponseHandler(groqChatChunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
    const toolCalls = [];
          ...
          transform(chunk, controller) {
            ...
            if (delta.tool_calls != null) {
              for (const toolCallDelta of delta.tool_calls) {
                ...
                if (toolCalls[index] == null) {
                  ...
                  if (((_i = toolCall2.function) == null ? void 0 : _i.name) != null && ((_j = toolCall2.function) == null ? void 0 : _j.arguments) != null) {
                    ...
                    if (chunkCSHG5LWU_cjs.isParsableJson(toolCall2.function.arguments)) {
                      ...
                      controller.enqueue({
                        type: "tool-call",
                        toolCallId: (_k = toolCall2.id) != null ? _k : chunkCSHG5LWU_cjs.generateId(),
                        toolName: toolCall2.function.name,
                        input: toolCall2.function.arguments
                      });
                      toolCall2.hasFinished = true;
                ...
                if (((_p = toolCall.function) == null ? void 0 : _p.name) != null && ((_q = toolCall.function) == null ? void 0 : _q.arguments) != null && chunkCSHG5LWU_cjs.isParsableJson(toolCall.function.arguments)) {
                  controller.enqueue({
                    type: "tool-input-end",
                    id: toolCall.id
                  });
                  controller.enqueue({
                    type: "tool-call",
                    toolCallId: (_r = toolCall.id) != null ? _r : chunkCSHG5LWU_cjs.generateId(),
                    toolName: toolCall.function.name,
                    input: toolCall.function.arguments
                  });
                  toolCall.hasFinished = true;
...
var GroqTranscriptionModel = class {
  ...
  async getArgs({
    ...
    const blob = audio instanceof Uint8Array ? new Blob([audio]) : new Blob([chunkCSHG5LWU_cjs.convertBase64ToUint8Array(audio)]);
    formData.append("model", this.modelId);
    const fileExtension = chunkCSHG5LWU_cjs.mediaTypeToExtension(mediaType);
    formData.append(
      "file",
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      responseHeaders,
      rawValue: rawResponse
    } = await chunkCSHG5LWU_cjs.postFormDataToApi({
      url: this.config.url({
...
var browserSearch = chunkCSHG5LWU_cjs.createProviderDefinedToolFactory({
...
function createGroq(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunkCSHG5LWU_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a15 : "https://api.groq.com/openai/v1";
  const getHeaders = () => chunkCSHG5LWU_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkCSHG5LWU_cjs.loadApiKey({
        apiKey: options.apiKey,
            ...
            switch (part.type) {
              ...
              case "file": {
                if (part.mediaType.startsWith("image/")) {
                  ...
                  return {
                    type: "image_url",
                    image_url: part.data instanceof URL ? part.data.toString() : `data:${mediaType};base64,${chunkCSHG5LWU_cjs.convertToBase64(part.data)}`
                  };
...
var mistralFailedResponseHandler = chunkCSHG5LWU_cjs.createJsonErrorResponseHandler({
...
var MistralChatLanguageModel = class {
  constructor(modelId, config) {
    ...
    this.modelId = modelId;
    this.config = config;
    this.generateId = (_a15 = config.generateId) != null ? _a15 : chunkCSHG5LWU_cjs.generateId;
  }
  get provider() {
    return this.config.provider;
  }
  async getArgs({
    ...
    var _a15, _b, _c, _d;
    const warnings = [];
    const options = (_a15 = await chunkCSHG5LWU_cjs.parseProviderOptions({
      provider: "mistral",
      providerOptions,
    ...
    if ((responseFormat == null ? void 0 : responseFormat.type) === "json" && !(responseFormat == null ? void 0 : responseFormat.schema)) {
      prompt = chunkCSHG5LWU_cjs.injectJsonInstructionIntoMessages({
        messages: prompt,
        schema: responseFormat.schema
      });
    }
...
var MistralEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    if (values.length > this.maxEmbeddingsPerCall) {
      throw new chunkCSHG5LWU_cjs.TooManyEmbeddingValuesForCallError({
...
function createMistral(options = {}) {
  var _a15;
  const baseURL = (_a15 = chunkCSHG5LWU_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a15 : "https://api.mistral.ai/v1";
  const getHeaders = () => chunkCSHG5LWU_cjs.withUserAgentSuffix(
    {
      Authorization: `Bearer ${chunkCSHG5LWU_cjs.loadApiKey({
        apiKey: options.apiKey,
            ...
            case "file": {
              if (part.mediaType === "application/pdf") {
                return part.data instanceof URL ? {
                  ...
                  type: "file_url",
                  file_url: {
                    url: typeof part.data === "string" ? part.data : chunkCSHG5LWU_cjs.convertUint8ArrayToBase64(part.data)
                  },
                ...
                return part.data instanceof URL ? {
                  ...
                  type: "image_url",
                  image_url: {
                    url: `data:${(_a15 = part.mediaType) != null ? _a15 : "image/jpeg"};base64,${typeof part.data === "string" ? part.data : chunkCSHG5LWU_cjs.convertUint8ArrayToBase64(part.data)}`
                  }
                };
              }
            }
...
function createPerplexity(options = {}) {
  ...
  const createLanguageModel = (modelId) => {
    ...
    return new PerplexityLanguageModel(modelId, {
      baseURL: chunkCSHG5LWU_cjs.withoutTrailingSlash(
        (_a15 = options.baseURL) != null ? _a15 : "https://api.perplexity.ai"
      ),
      headers: getHeaders,
      generateId: chunkCSHG5LWU_cjs.generateId,
      fetch: options.fetch
    });
  };
  const provider = (modelId) => createLanguageModel(modelId);
...
function createTogetherAI(options = {}) {
  ...
  const createChatModel = (modelId) => {
    return new chunkCSHG5LWU_cjs.OpenAICompatibleChatLanguageModel(
      modelId,
      getCommonModelConfig("chat")
    );
  };
...
var xaiFailedResponseHandler = chunkCSHG5LWU_cjs.createJsonErrorResponseHandler({
...
var XaiChatLanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    if (response.error != null) {
      throw new chunkCSHG5LWU_cjs.APICallError({
  ...
  async doStream(options) {
    ...
    const { responseHeaders, value: response } = await chunkCSHG5LWU_cjs.postJsonToApi({
      ...
      successfulResponseHandler: async ({ response: response2 }) => {
        const responseHeaders2 = chunkCSHG5LWU_cjs.extractResponseHeaders(response2);
        const contentType = response2.headers.get("content-type");
        if (contentType == null ? void 0 : contentType.includes("application/json")) {
          const responseBody = await response2.text();
          const parsedError = await chunkCSHG5LWU_cjs.safeParseJSON({
            text: responseBody,
        ...
        return chunkCSHG5LWU_cjs.createEventSourceResponseHandler(xaiChatChunkSchema)({
          response: response2,
          url,
          requestBodyValues: body
        });
          ...
          switch (block.type) {
            ...
            case "file": {
              if (block.mediaType.startsWith("image/")) {
                ...
                const imageUrl = block.data instanceof URL ? block.data.toString() : `data:${mediaType};base64,${chunkCSHG5LWU_cjs.convertToBase64(block.data)}`;
...
var webSearchArgsSchema = chunkCSHG5LWU_cjs.lazySchema(
  () => chunkCSHG5LWU_cjs.zodSchema(
    v4.z.object({
...
var webSearchOutputSchema = chunkCSHG5LWU_cjs.lazySchema(
  () => chunkCSHG5LWU_cjs.zodSchema(
    v4.z.object({
      query: v4.z.string(),
      sources: v4.z.array(
...
var webSearchToolFactory = chunkCSHG5LWU_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.web_search",
  name: "web_search",
  inputSchema: chunkCSHG5LWU_cjs.lazySchema(() => chunkCSHG5LWU_cjs.zodSchema(v4.z.object({}))),
  outputSchema: webSearchOutputSchema
});
var webSearch = (args = {}) => webSearchToolFactory(args);
var xSearchArgsSchema = chunkCSHG5LWU_cjs.lazySchema(
  () => chunkCSHG5LWU_cjs.zodSchema(
    v4.z.object({
...
var xSearchOutputSchema = chunkCSHG5LWU_cjs.lazySchema(
  () => chunkCSHG5LWU_cjs.zodSchema(
    v4.z.object({
      query: v4.z.string(),
      posts: v4.z.array(
...
var xSearchToolFactory = chunkCSHG5LWU_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.x_search",
  name: "x_search",
  inputSchema: chunkCSHG5LWU_cjs.lazySchema(() => chunkCSHG5LWU_cjs.zodSchema(v4.z.object({}))),
...
async function prepareResponsesTools({
  ...
  for (const tool of normalizedTools) {
    ...
    if (tool.type === "provider-defined") {
      switch (tool.id) {
        case "xai.web_search": {
          const args = await chunkCSHG5LWU_cjs.validateTypes({
            value: tool.args,
...
var codeExecutionToolFactory = chunkCSHG5LWU_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var viewImageToolFactory = chunkCSHG5LWU_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.view_image",
  name: "view_image",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
var viewXVideoToolFactory = chunkCSHG5LWU_cjs.createProviderDefinedToolFactoryWithOutputSchema({
  id: "xai.view_x_video",
  name: "view_x_video",
  inputSchema: v4.z.object({}).describe("no input parameters"),
...
function createXai(options = {}) {
  ...
  const createImageModel = (modelId) => {
    return new chunkCSHG5LWU_cjs.OpenAICompatibleImageModel(modelId, {
      provider: "xai.image",
      url: ({ path }) => `${baseURL}${path}`,
      headers: getHeaders,
      fetch: options.fetch,
...
var ModelsDevGateway = class extends chunkCSHG5LWU_cjs.MastraModelGateway {
  id = "models.dev";
  name = "models.dev";
  providerConfigs = {};
  ...
  async resolveLanguageModel({
    ...
    switch (providerId) {
      case "openai":
        return chunkCSHG5LWU_cjs.createOpenAI({ apiKey }).responses(modelId);
      case "gemini":
      case "google":
        return chunkCSHG5LWU_cjs.createGoogleGenerativeAI({
          apiKey
        }).chat(modelId);
      case "anthropic":
        return chunkCSHG5LWU_cjs.createAnthropic({ apiKey })(modelId);
      case "mistral":
      ...
      case "vercel":
        return chunkH5S4PS44_cjs.createGatewayProvider({ apiKey, headers })(modelId);
      case "moonshotai":
      case "moonshotai-cn": {
        if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
        return chunkCSHG5LWU_cjs.createAnthropic({ apiKey, baseURL })(modelId);
      }
      default: {
        const config = this.providerConfigs[providerId];
        ...
        if (npm === "@ai-sdk/openai") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunkCSHG5LWU_cjs.createOpenAI({ apiKey, baseURL }).chat(modelId);
        }
        if (npm === "@ai-sdk/google") {
          if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
          return chunkCSHG5LWU_cjs.createGoogleGenerativeAI({ apiKey, baseURL }).chat(modelId);
        }
        ...
        if (!baseURL) throw new Error(`No API URL found for ${providerId}/${modelId}`);
        return chunkCSHG5LWU_cjs.createOpenAICompatible({ name: providerId, apiKey, baseURL, supportsStructuredOutputs: true }).chatModel(
          modelId
        );
      }
    }
...
//# sourceMappingURL=chunk-BN5MV2QK.cjs.map
//# sourceMappingURL=chunk-BN5MV2QK.cjs.map