...
var getTraceStep = chunkL3WDI7HP_cjs.createStep({
...
async function validateAndSaveScore({ storage, scorerResult }) {
  ...
  const payloadToSave = chunk3ZBLD2Y4_cjs.saveScorePayloadSchema.parse(scorerResult);
...
var scoreTracesWorkflow = chunkL3WDI7HP_cjs.createWorkflow({
