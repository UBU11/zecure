...
var entityTypeField = zod.z.nativeEnum(chunk4UOWNFAL_cjs.EntityType).describe(`Entity type (e.g., 'agent' | 'processor' | 'tool' | 'workflow')`);
...
var scoringEntityTypeSchema = zod.z.enum(["AGENT", "WORKFLOW", ...Object.values(chunk4UOWNFAL_cjs.SpanType)]);
...
var spanTypeField = zod.z.nativeEnum(chunk4UOWNFAL_cjs.SpanType).describe("Span type (e.g., WORKFLOW_RUN, AGENT_RUN, TOOL_CALL, etc.)");
...
var TABLE_MCP_SERVERS = "mastra_mcp_servers";
var TABLE_MCP_SERVER_VERSIONS = "mastra_mcp_server_versions";
...
var MCP_SERVERS_SCHEMA = {
  id: { type: "text", nullable: false, primaryKey: true },
  status: { type: "text", nullable: false },
  // 'draft', 'published', or 'archived'
  activeVersionId: { type: "text", nullable: true },
  // FK to mcp_server_versions.id
  authorId: { type: "text", nullable: true },
  metadata: { type: "jsonb", nullable: true },
  createdAt: { type: "timestamp", nullable: false },
  updatedAt: { type: "timestamp", nullable: false }
};
var MCP_SERVER_VERSIONS_SCHEMA = {
  id: { type: "text", nullable: false, primaryKey: true },
...
exports.MCP_SERVERS_SCHEMA = MCP_SERVERS_SCHEMA;
exports.MCP_SERVER_VERSIONS_SCHEMA = MCP_SERVER_VERSIONS_SCHEMA;
...
exports.TABLE_MCP_SERVERS = TABLE_MCP_SERVERS;
exports.TABLE_MCP_SERVER_VERSIONS = TABLE_MCP_SERVER_VERSIONS;
...
//# sourceMappingURL=chunk-3ZBLD2Y4.cjs.map
//# sourceMappingURL=chunk-3ZBLD2Y4.cjs.map