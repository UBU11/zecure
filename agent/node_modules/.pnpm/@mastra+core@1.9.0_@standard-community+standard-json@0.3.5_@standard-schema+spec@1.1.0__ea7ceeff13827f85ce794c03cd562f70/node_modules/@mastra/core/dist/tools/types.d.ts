 ...
 */
export type MastraToolInvocationOptions = ToolInvocationOptions & Partial<ObservabilityContext> & {
...
export interface ToolExecutionContext<TSuspend = unknown, TResume = unknown, TRequestContext extends Record<string, any> | unknown = unknown> extends Partial<ObservabilityContext> {
    mastra?: MastraUnion;
...
export interface ToolAction<TSchemaIn, TSchemaOut, TSuspend = unknown, TResume = unknown, TContext extends ToolExecutionContext<TSuspend, TResume, any> = ToolExecutionContext<TSuspend, TResume>, TId extends string = string, TRequestContext extends Record<string, any> | unknown = unknown> {
    id: TId;
    description: string;
