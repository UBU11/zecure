...
function validateUpsertInput(storeName, vectors, metadata, ids) {
  if (!vectors || vectors.length === 0) {
    throw new chunk4U7ZLI36_cjs.MastraError({
      id: chunkZBESCKPX_cjs.createVectorErrorId(storeName, "UPSERT", "EMPTY_VECTORS"),
      domain: "MASTRA_VECTOR" /* MASTRA_VECTOR */,
      category: "USER" /* USER */,
      details: {
  ...
  if (metadata && metadata.length > 0 && metadata.length !== vectors.length) {
    throw new chunk4U7ZLI36_cjs.MastraError({
      id: chunkZBESCKPX_cjs.createVectorErrorId(storeName, "UPSERT", "METADATA_LENGTH_MISMATCH"),
      domain: "MASTRA_VECTOR" /* MASTRA_VECTOR */,
      category: "USER" /* USER */,
      details: {
  ...
  if (ids && ids.length !== vectors.length) {
    throw new chunk4U7ZLI36_cjs.MastraError({
      id: chunkZBESCKPX_cjs.createVectorErrorId(storeName, "UPSERT", "IDS_LENGTH_MISMATCH"),
      domain: "MASTRA_VECTOR" /* MASTRA_VECTOR */,
      category: "USER" /* USER */,
      details: {
...
function validateTopK(storeName, topK) {
  if (!Number.isInteger(topK) || topK <= 0) {
    throw new chunk4U7ZLI36_cjs.MastraError({
      id: chunkZBESCKPX_cjs.createVectorErrorId(storeName, "QUERY", "INVALID_TOP_K"),
      domain: "MASTRA_VECTOR" /* MASTRA_VECTOR */,
      category: "USER" /* USER */,
      details: {
...
function validateVectorValues(storeName, vectors) {
  for (let i = 0; i < vectors.length; i++) {
    ...
    if (!vector) {
      throw new chunk4U7ZLI36_cjs.MastraError({
        id: chunkZBESCKPX_cjs.createVectorErrorId(storeName, "UPSERT", "INVALID_VECTOR"),
        domain: "MASTRA_VECTOR" /* MASTRA_VECTOR */,
        category: "USER" /* USER */,
        details: {
    ...
    for (let j = 0; j < vector.length; j++) {
      ...
      if (value === null || value === void 0 || !Number.isFinite(value)) {
        throw new chunk4U7ZLI36_cjs.MastraError({
          id: chunkZBESCKPX_cjs.createVectorErrorId(storeName, "UPSERT", "INVALID_VECTOR_VALUE"),
          domain: "MASTRA_VECTOR" /* MASTRA_VECTOR */,
          category: "USER" /* USER */,
          details: {
...
Object.defineProperty(exports, "embedV3", {
  enumerable: true,
  get: function () { return chunkH5S4PS44_cjs.embed; }
});
