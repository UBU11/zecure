...
var GET_AUTH_CAPABILITIES_ROUTE = chunkK52BGIHQ_cjs.createPublicRoute({
  method: "GET",
  ...
  handler: async (ctx) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error getting auth capabilities");
    }
  }
});
var GET_CURRENT_USER_ROUTE = chunkK52BGIHQ_cjs.createPublicRoute({
  method: "GET",
  path: "/auth/me",
  responseType: "json",
  ...
  handler: async (ctx) => {
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error getting current user");
    }
  }
});
var GET_SSO_LOGIN_ROUTE = chunkK52BGIHQ_cjs.createPublicRoute({
  method: "GET",
  path: "/auth/sso/login",
  ...
  handler: async (ctx) => {
    try {
      ...
      if (!auth || !implementsInterface(auth, "getLoginUrl")) {
        throw new chunk64ITUOXI_cjs.HTTPException(404, { message: "SSO not configured" });
      }
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error initiating SSO login");
    }
  }
});
var GET_SSO_CALLBACK_ROUTE = chunkK52BGIHQ_cjs.createPublicRoute({
  method: "GET",
...
var POST_LOGOUT_ROUTE = chunkK52BGIHQ_cjs.createPublicRoute({
  method: "POST",
  path: "/auth/logout",
  responseType: "datastream-response",
  summary: "Logout",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      return chunkSUKFO7UM_cjs.handleError(error, "Error logging out");
    }
  }
});
var POST_CREDENTIALS_SIGN_IN_ROUTE = chunkK52BGIHQ_cjs.createPublicRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      if (!auth || !implementsInterface(auth, "signIn")) {
        throw new chunk64ITUOXI_cjs.HTTPException(404, { message: "Credentials authentication not configured" });
      }
      ...
      throw new chunk64ITUOXI_cjs.HTTPException(401, { message: "Invalid email or password" });
    }
  }
});
var POST_CREDENTIALS_SIGN_UP_ROUTE = chunkK52BGIHQ_cjs.createPublicRoute({
  method: "POST",
  ...
  handler: async (ctx) => {
    ...
    try {
      ...
      throw new chunk64ITUOXI_cjs.HTTPException(400, { message: "Failed to create account" });
    }
  }
});
var AUTH_ROUTES = [
...
//# sourceMappingURL=chunk-EGWACN4Q.cjs.map
//# sourceMappingURL=chunk-EGWACN4Q.cjs.map