...
function isToolLoopAgentLike(obj) {
  if (!obj) return false;
  if (obj instanceof chunkH5S4PS44_cjs.ToolLoopAgent) return true;
  ...
  async handlePrepareStep(args, currentResult) {
    if (this.settings.prepareStep) {
      ...
      if (currentResult.model) {
        const resolvedModel = await chunkWU2P7XOU_cjs.resolveModelConfig(currentResult.model);
        if (!chunkYIJZBU54_cjs.isSupportedLanguageModel(resolvedModel)) {
...
function toolLoopAgentToMastraAgent(agent, options) {
  ...
  return new chunkYIJZBU54_cjs.Agent({
    ...agentConfig,
    id,
...
//# sourceMappingURL=chunk-HAGCXIBX.cjs.map
//# sourceMappingURL=chunk-HAGCXIBX.cjs.map