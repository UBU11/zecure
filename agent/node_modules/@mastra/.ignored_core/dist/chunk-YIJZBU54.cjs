...
var chunk4P35AVPE_cjs = require('./chunk-4P35AVPE.cjs');
var chunkZBESCKPX_cjs = require('./chunk-ZBESCKPX.cjs');
var chunk3ZF7IC6Q_cjs = require('./chunk-3ZF7IC6Q.cjs');
...
var chunkWU2P7XOU_cjs = require('./chunk-WU2P7XOU.cjs');
var chunkPKORY4ZZ_cjs = require('./chunk-PKORY4ZZ.cjs');
var chunk6BJ7XHRH_cjs = require('./chunk-6BJ7XHRH.cjs');
var chunkOQDRPRKM_cjs = require('./chunk-OQDRPRKM.cjs');
var chunkQNXY3J6B_cjs = require('./chunk-QNXY3J6B.cjs');
var chunk4UOWNFAL_cjs = require('./chunk-4UOWNFAL.cjs');
...
var StructuredOutputProcessor = class {
  ...
  async processOutputStream(args) {
    ...
    const observabilityContext = chunk4UOWNFAL_cjs.resolveObservabilityContext(rest);
...
var ProcessorRunner = class _ProcessorRunner {
  ...
  async runOutputProcessors(messageList, observabilityContext, requestContext, retryCount = 0, writer) {
    for (const [index, processorOrWorkflow] of this.outputProcessors.entries()) {
      ...
      const result = await processMethod({
        ...
        abort,
        ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: processorSpan }),
        requestContext,
        retryCount,
        writer
      });
      const mutations = messageList.stopRecording();
      if (result instanceof chunk3ZF7IC6Q_cjs.MessageList) {
        ...
        try {
          if (processor.processOutputStream && processedPart) {
            ...
            const result = await processor.processOutputStream({
              ...
              ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: state.span }),
              requestContext,
              messageList,
              retryCount,
              writer
  ...
  async runProcessInputStep(args) {
    ...
    const observabilityContext = chunk4UOWNFAL_cjs.resolveObservabilityContext(args);
    const stepInput = {
      tools: args.tools,
  ...
  static async validateAndFormatProcessInputStepResult(result, {
    ...
    if (result instanceof chunk3ZF7IC6Q_cjs.MessageList) {
      ...
      if (result.model) {
        const resolvedModel = await chunkWU2P7XOU_cjs.resolveModelConfig(result.model);
          ...
          async transform(chunk, controller) {
            if (chunk.type === "finish" && chunk.payload?.stepResult?.reason === "tool-calls") {
              ...
              const {
                ...
                chunk,
                processorStates,
                chunk4UOWNFAL_cjs.resolveObservabilityContext(options),
            ...
            case "finish":
              ...
              try {
                if (self.processorRunner && !self.#options.isLLMExecutionStep) {
                  ...
                  const outputText = lastResponseMessage ? chunk3ZF7IC6Q_cjs.coreContentToString(lastResponseMessage.content) : "";
  ...
  switch (chunk.type) {
    ...
    case "file":
      if (mode === "generate") {
        return {
          type: "file",
          file: new chunk3ZF7IC6Q_cjs.DefaultGeneratedFile({
      ...
      return {
        type: "file",
        file: new chunk3ZF7IC6Q_cjs.DefaultGeneratedFileWithType({
          data: chunk.payload.data,
          mediaType: chunk.payload.mimeType
        })
      };
...
async function validateStepInput({
  ...
  let validationError;
  if (validateInputs && chunkQNXY3J6B_cjs.isZodType(step.inputSchema)) {
...
async function validateStepResumeData({ resumeData, step }) {
  ...
  if (resumeSchema && chunkQNXY3J6B_cjs.isZodType(resumeSchema)) {
...
async function validateStepSuspendData({
  ...
  if (suspendSchema && validateInputs && chunkQNXY3J6B_cjs.isZodType(suspendSchema)) {
...
async function validateStepStateData({
  ...
  if (stateSchema && validateInputs && chunkQNXY3J6B_cjs.isZodType(stateSchema)) {
...
async function validateStepRequestContext({
  ...
  if (requestContextSchema && validateInputs && chunkQNXY3J6B_cjs.isZodType(requestContextSchema)) {
...
var createTimeTravelExecutionParams = (params) => {
  ...
  for (const [index, entry] of graph.steps.entries()) {
    ...
    stepIds.forEach((stepId) => {
      ...
      if (result) {
        const formattedResult = chunkQNXY3J6B_cjs.removeUndefinedValues(result);
  ...
  const results = await Promise.all(
    entry.steps.map(async (step, i) => {
      ...
      const stepExecResult = await engine.executeStep({
        ...
        ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: parallelSpan }),
        pubsub,
        abortController,
        requestContext,
        outputWriter,
      ...
      const context = createDeprecationProxy(
        {
          ...
          state: executionContext.state,
          retryCount: -1,
          ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: evalSpan }),
  ...
  const results = await Promise.all(
    stepsToRun.map(async (step) => {
      ...
      const stepExecResult = await engine.executeStep({
        ...
        ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: conditionalSpan }),
        pubsub,
        abortController,
        requestContext,
        outputWriter,
...
async function executeLoop(engine, params) {
  ...
  do {
    const stepExecResult = await engine.executeStep({
      ...
      ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: loopSpan }),
      pubsub,
      abortController,
      requestContext,
      outputWriter,
    ...
    const evalSpan = await engine.createChildSpan({
      ...
      options: {
        ...
        input: chunkQNXY3J6B_cjs.selectFields(result.output, ["stepResult", "output.text", "output.object", "messages"]),
        attributes: {
...
async function persistStepUpdate(engine, params) {
  ...
  await engine.wrapDurableOperation(operationId, async () => {
    ...
    const ctx = requestContext instanceof chunkVDKWYUGC_cjs.RequestContext ? requestContext : new chunkVDKWYUGC_cjs.RequestContext(requestContext);
  ...
  if (fn) {
    ...
    duration = await engine.wrapDurableOperation(`workflow.${workflowId}.sleep.${entry.id}`, async () => {
      return fn({
        ...
        retryCount: -1,
        ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: sleepSpan }),
        getInitData: () => stepResults?.input,
        getStepResult: getStepResult.bind(null, stepResults),
  ...
  if (fn) {
    ...
    const dateResult = await engine.wrapDurableOperation(`workflow.${workflowId}.sleepUntil.${entry.id}`, async () => {
      return fn({
        ...
        retryCount: -1,
        ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: sleepUntilSpan }),
        getInitData: () => stepResults?.input,
        getStepResult: getStepResult.bind(null, stepResults),
        // TODO: this function shouldn't have suspend probably?
        suspend: async (_suspendPayload) => {
...
async function executeStep(engine, params) {
  ...
  const stepRetryResult = await engine.executeStepWithRetry(
    ...
    async () => {
      ...
      const mastraForStep = engine.mastra ? isNestedWorkflow ? engine.mastra : chunk4UOWNFAL_cjs.wrapMastra(engine.mastra, { currentSpan: stepSpan }) : void 0;
      const output = await runStep({
        ...
        ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: stepSpan }),
        getInitData: () => stepResults?.input,
        getStepResult: getStepResult.bind(null, stepResults),
  ...
  async execute(params) {
    ...
    for (let i = startIdx; i < steps.length; i++) {
      ...
      lastOutput = await this.executeEntry({
        ...
        timeTravel,
        restart,
        ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: workflowSpan }),
...
function isToolStep(input) {
  return input instanceof chunkD6HO5QAM_cjs.Tool;
}
function isStepParams(input) {
  return input !== null && typeof input === "object" && "id" in input && "execute" in input && !(input instanceof Agent) && !(input instanceof chunkD6HO5QAM_cjs.Tool);
}
...
function createStepFromProcessor(processor) {
  ...
  return {
    ...
    execute: async ({ inputData, requestContext, tracingContext, outputWriter }) => {
      ...
      const processorObservabilityContext = chunk4UOWNFAL_cjs.createObservabilityContext(
      ...
      const passThrough = {
        ...
        messageList: messageList ?? (Array.isArray(messages) ? new chunk3ZF7IC6Q_cjs.MessageList().add(messages, "input").addSystem(systemMessages ?? []) : void 0),
        stepNumber,
        systemMessages,
        streamParts,
        state,
        ...
        switch (phase) {
          ...
          case "outputStream": {
            if (processor.processOutputStream) {
              ...
              const processorObservabilityContext2 = chunk4UOWNFAL_cjs.createObservabilityContext(
...
function isProcessor(obj) {
  return obj !== null && typeof obj === "object" && "id" in obj && typeof obj.id === "string" && !(obj instanceof Agent) && !(obj instanceof chunkD6HO5QAM_cjs.Tool) && (typeof obj.processInput === "function" || typeof obj.processInputStep === "function" || typeof obj.processOutputStream === "function" || typeof obj.processOutputResult === "function" || typeof obj.processOutputStep === "function");
}
...
var Run = class {
  ...
  async _validateInput(inputData) {
    ...
    if (this.validateInputs && this.inputSchema && chunkQNXY3J6B_cjs.isZodType(this.inputSchema)) {
  ...
  async _validateInitialState(initialState) {
    ...
    if (this.validateInputs) {
      ...
      if (stateSchema && chunkQNXY3J6B_cjs.isZodType(stateSchema)) {
  ...
  async _validateRequestContext(requestContext) {
    if (this.validateInputs && this.requestContextSchema && chunkQNXY3J6B_cjs.isZodType(this.requestContextSchema)) {
      const contextValues = requestContext?.all ?? {};
...
` + errors.map((e) => `- ${e.path?.join(".")}: ${e.message}`).join("\n")
  ...
  async _validateResumeData(resumeData, suspendedStep) {
    ...
    if (suspendedStep && suspendedStep.resumeSchema && this.validateInputs && chunkQNXY3J6B_cjs.isZodType(suspendedStep.resumeSchema)) {
  ...
  async _validateTimetravelInputData(inputData, step) {
    let inputDataToUse = inputData;
    if (step && step.inputSchema && this.validateInputs && chunkQNXY3J6B_cjs.isZodType(step.inputSchema)) {
      const inputSchema = step.inputSchema;
  ...
  async _start({
    ...
    const observabilityContext = chunk4UOWNFAL_cjs.resolveObservabilityContext(rest);
    const workflowSpan = chunk4UOWNFAL_cjs.getOrCreateSpan({
  ...
  async _resume(params) {
    const observabilityContext = chunk4UOWNFAL_cjs.resolveObservabilityContext(params);
    const workflowsStore = await this.#mastra?.getStorage()?.getStore("workflows");
...
var llmIterationOutputSchema = z10__default.default.object({
  ...
  isTaskCompleteCheckFailed: z10__default.default.boolean().optional()
...
var MastraScorer = class _MastraScorer {
  ...
  async run(input) {
    ...
    const observabilityContext = chunk4UOWNFAL_cjs.resolveObservabilityContext(input);
  ...
  async executePromptStep(scorerStep, observabilityContext, context) {
    ...
    const resolvedModel = await chunkWU2P7XOU_cjs.resolveModelConfig(modelConfig, void 0, this.#mastra);
...
function createLLMExecutionStep({
  ...
  return createStep({
    ...
    execute: async ({ inputData, bail, tracingContext }) => {
      currentIteration++;
      const messageId = inputData.isTaskCompleteCheckFailed ? `${messageIdPassed}-${currentIteration}` : messageIdPassed;
        ...
        if (inputStepProcessors && inputStepProcessors.length > 0) {
          ...
          try {
            ...
            const processInputStepResult = await processorRunner.runProcessInputStep({
              ...
              ...chunk4UOWNFAL_cjs.createObservabilityContext(stepTracingContext),
              requestContext,
              model,
...
Analyse the suspended tools: ${JSON.stringify(suspendedTools)}, using the messages available to you and the resumeSchema of each suspended tool, find the tool whose resumeData you can construct properly.
        ...
        if (isSupportedLanguageModel(currentStep.model)) {
          modelResult = chunk4UOWNFAL_cjs.executeWithContextSync({
        ...
        if (currentStep.model instanceof chunkWU2P7XOU_cjs.ModelRouterLanguageModel) {
      ...
      if (outputProcessors && outputProcessors.length > 0) {
        ...
        try {
          ...
          await processorRunner.runProcessOutputStep({
            ...
            text: immediateText,
            ...chunk4UOWNFAL_cjs.createObservabilityContext(outputStepTracingContext),
            requestContext,
...
function createLLMMappingStep({ models, _internal, ...rest }, llmExecutionStep) {
  ...
  const observabilityContext = chunk4UOWNFAL_cjs.createObservabilityContext(rest.modelSpanTracker?.getTracingContext());
              ...
              parts: errorResults.map((toolCallErrorResult) => {
                return {
                  ...
                  toolInvocation: {
                    ...
                    toolName: chunk3ZF7IC6Q_cjs.sanitizeToolName(toolCallErrorResult.toolName),
                    ...
                    clientResults.map(async (toolCall) => {
                      ...
                      return {
                        ...
                        toolInvocation: {
                          state: "result",
                          toolCallId: toolCall.toolCallId,
                          toolName: chunk3ZF7IC6Q_cjs.sanitizeToolName(toolCall.toolName),
                          args: toolCall.args,
                          result: toolCall.result
                        },
                        ...providerMetadata ? { providerMetadata } : {}
      ...
      try {
        ...
        if (iterationResult) {
          ...
          if (iterationResult.feedback && typedInputData.stepResult?.isContinued && !hasFinishedSteps) {
            messageList.add(
              {
                id: rest.mastra?.generateId() || crypto2.randomUUID(),
                createdAt: /* @__PURE__ */ new Date(),
                type: "text",
                role: "assistant",
                content: {
  ...
  return new web.ReadableStream({
    start: async (controller) => {
      ...
      const executionResult = resumeContext ? await run.resume({
        ...
        ...chunk4UOWNFAL_cjs.createObservabilityContext(rest.modelSpanTracker?.getTracingContext()),
        requestContext,
        label: toolCallId
      }) : await run.start({
        ...
        options: {
          ...
          onStepFinish: async (props) => {
            ...
            if (!isNaN(remainingTokens) && remainingTokens > 0 && remainingTokens < 2e3) {
              ...
              await chunkQNXY3J6B_cjs.delay(10 * 1e3);
            }
          },
...
async function prepareMemoryStep({
  ...
  if (typeof messages === "string") {
    ...
    const messageList = new chunk3ZF7IC6Q_cjs.MessageList({
      threadId: thread?.id,
      resourceId: thread?.resourceId
    });
...
async function saveMessagesWithProcessors(memory, messages, processorRunner, context) {
  ...
  await processorRunner.runOutputProcessors(
    messageList,
    chunk4UOWNFAL_cjs.resolveObservabilityContext(observabilityContext),
    requestContext
  );
    ...
    execute: async ({ inputData, getInitData, writer, resumeData, mastra, suspend }) => {
      ...
      const finalResult = await tool2.execute(
        inputDataToUse,
        {
          ...
          ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: void 0 }),
          writer
        },
        { toolCallId, messages: [] }
      );
        ...
        if (requireApprovalMetadata || suspendedTools) {
          ...
          `;
              ...
              const result = llm.stream({
                ...
                messageList,
                agentId: routingAgent.id,
                ...chunk4UOWNFAL_cjs.resolveObservabilityContext(routingAgentOptions ?? {}),
                structuredOutput: {
                  schema: z10__default.default.object({
...
${skillInstructions}`;
  ...
  createSkillActivateTool() {
    ...
    return chunkD6HO5QAM_cjs.createTool({
      id: "skill-activate",
  ...
  createSkillReadReferenceTool() {
    ...
    return chunkD6HO5QAM_cjs.createTool({
      ...
      inputSchema: z10__default.default.object({
        ...
        referencePath: z10__default.default.string().describe(
      ...
      execute: async ({ skillName, referencePath, startLine, endLine }) => {
        ...
        const result = chunk4P35AVPE_cjs.extractLines(fullContent, startLine, endLine);
        return {
          success: true,
  ...
  createSkillReadScriptTool() {
    ...
    return chunkD6HO5QAM_cjs.createTool({
      ...
      inputSchema: z10__default.default.object({
        skillName: z10__default.default.string().describe("The name of the activated skill"),
        scriptPath: z10__default.default.string().describe('Path to the script file (relative to the skill root directory, e.g. "scripts/run.sh")'),
        startLine: z10__default.default.number().optional().describe("Starting line number (1-indexed). If omitted, starts from the beginning."),
        endLine: z10__default.default.number().optional().describe("Ending line number (1-indexed, inclusive). If omitted, reads to the end.")
      }),
  ...
  createSkillReadAssetTool() {
    ...
    return chunkD6HO5QAM_cjs.createTool({
      ...
      inputSchema: z10__default.default.object({
        skillName: z10__default.default.string().describe("The name of the activated skill"),
        assetPath: z10__default.default.string().describe('Path to the asset file (relative to the skill root directory, e.g. "assets/logo.png")')
      }),
...
var AgentLegacyHandler = class {
  ...
  __primitive({
    ...
    return {
      before: async () => {
        ...
        const agentSpan = chunk4UOWNFAL_cjs.getOrCreateSpan({
        ...
        const innerObservabilityContext = chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: agentSpan });
        ...
        let messageList = new chunk3ZF7IC6Q_cjs.MessageList({
          threadId,
          resourceId,
      ...
      after: async ({
        ...
        const messageListResponses = new chunk3ZF7IC6Q_cjs.MessageList({
          threadId,
          resourceId,
          generateMessageId: this.capabilities.mastra?.generateId?.bind(this.capabilities.mastra),
          // @ts-expect-error Flag for agent network messages
        ...
        if (memory && resourceId && thread2) {
          try {
            ...
            if (shouldGenerate && !thread2.title && userMessage) {
              const observabilityContext2 = chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: agentSpan });
              promises.push(
        ...
        await this.capabilities.runScorers({
          ...
          threadId,
          resourceId,
          ...chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: agentSpan })
        });
        const scoringData = {
          input: {
  ...
  async prepareLLMOptions(messages, options, methodType) {
    ...
    const { before, after } = this.__primitive({
      ...
      methodType,
      tracingOptions,
      ...chunk4UOWNFAL_cjs.resolveObservabilityContext(args)
    });
    let messageList;
    let thread;
    let threadExists;
  ...
  async generateLegacy(messages, generateOptions = {}) {
    ...
    const observabilityContext = chunk4UOWNFAL_cjs.createObservabilityContext({ currentSpan: agentSpan });
...
var prepareMemoryStepOutputSchema = z10.z.object({
  ...
  messageList: z10.z.instanceof(chunk3ZF7IC6Q_cjs.MessageList),
...
var Agent = class extends chunkRO47SMI7_cjs.MastraBase {
  ...
  async #validateRequestContext(requestContext) {
    if (this.#requestContextSchema && chunkQNXY3J6B_cjs.isZodType(this.#requestContextSchema)) {
      const contextValues = requestContext?.all ?? {};
      const validatedRequestContext = await this.#requestContextSchema.safeParseAsync(contextValues);
      if (!validatedRequestContext.success) {
...
${errorMessages}`,
  ...
  listTools({ requestContext = new chunkVDKWYUGC_cjs.RequestContext() } = {}) {
    if (typeof this.#tools !== "function") {
      return chunkQNXY3J6B_cjs.ensureToolProperties(this.#tools);
    }
    ...
    return resolveMaybePromise(result, (tools) => {
      ...
      return chunkQNXY3J6B_cjs.ensureToolProperties(tools);
    });
  }
  /**
  ...
  getLLM({
    ...
    return resolveMaybePromise(modelToUse, (resolvedModel) => {
      ...
      if (isSupportedLanguageModel(resolvedModel)) {
        ...
        llm = new chunkPKORY4ZZ_cjs.MastraLLMV1({
          model: resolvedModel,
          mastra: this.#mastra,
          options: { tracingPolicy: this.#options?.tracingPolicy }
        });
  ...
  async resolveModelConfig(modelConfig, requestContext) {
    try {
      return await chunkWU2P7XOU_cjs.resolveModelConfig(modelConfig, requestContext, this.#mastra);
    } catch (error) {
      const mastraError = new chunk4U7ZLI36_cjs.MastraError({
  ...
  async generateTitleFromUserMessage({
    ...
    const normMessage = new chunk3ZF7IC6Q_cjs.MessageList().add(message, "user").get.all.aiV5.ui().at(-1);
    if (!normMessage) {
    ...
    if (isSupportedLanguageModel(llm.getModel())) {
      const messageList = new chunk3ZF7IC6Q_cjs.MessageList().add(
        [
          {
            role: "system",
  ...
  async genTitle(userMessage, requestContext, observabilityContext, model, instructions) {
    try {
      if (userMessage) {
        const normMessage = new chunk3ZF7IC6Q_cjs.MessageList().add(userMessage, "user").get.all.ui().at(-1);
        if (normMessage) {
  ...
  async listMemoryTools({
    ...
    if (memoryTools) {
      ...
      for (const [toolName, tool2] of Object.entries(memoryTools)) {
        ...
        const convertedToCoreTool = chunkQNXY3J6B_cjs.makeCoreTool(toolObj, options, void 0, autoResumeSuspendedTools);
  ...
  async listWorkspaceTools({
    ...
    const workspaceTools = chunk4P35AVPE_cjs.createWorkspaceTools(workspace);
  ...
  async listAssignedTools({
    ...
    const assignedCoreToolEntries = await Promise.all(
      assignedToolEntries.map(async ([k, tool2]) => {
        ...
        return [k, chunkQNXY3J6B_cjs.makeCoreTool(tool2, options, void 0, autoResumeSuspendedTools)];
      })
    );
    ...
    if (toolsFromToolsets.length > 0) {
      ...
      for (const toolset of toolsFromToolsets) {
        for (const [toolName, tool2] of Object.entries(toolset)) {
          ...
          const convertedToCoreTool = chunkQNXY3J6B_cjs.makeCoreTool(toolObj, options, "toolset", autoResumeSuspendedTools);
  ...
  async listClientTools({
    ...
    if (clientToolsForInput.length > 0) {
      ...
      for (const [toolName, tool2] of clientToolsForInput) {
        ...
        const convertedToCoreTool = chunkQNXY3J6B_cjs.makeCoreTool(toolRest, options, "client-tool", autoResumeSuspendedTools);
        toolsForRequest[toolName] = convertedToCoreTool;
      }
    }
    return toolsForRequest;
    ...
    if (Object.keys(agents).length > 0) {
      for (const [agentName, agent] of Object.entries(agents)) {
        const agentInputSchema = z10.z.object({
          ...
          instructions: z10.z.string().nullish().describe(
        ...
        const toolObj = chunkD6HO5QAM_cjs.createTool({
          id: `agent-${agentName}`,
          ...
          execute: async (inputData, context) => {
            const startTime = Date.now();
            const toolCallId = context?.agent?.toolCallId || crypto2.randomUUID();
            const contextMessages = context?.agent?.messages || [];
            let fullSubAgentMessages = contextMessages;
            ...
            const delegationStartContext = {
              ...
              runId: runId || crypto2.randomUUID(),
              threadId,
              resourceId,
            ...
            const subAgentThreadId = inputData.threadId ? `${inputData.threadId}-${crypto2.randomUUID()}` : context?.mastra?.generateId({
              idType: "thread",
              source: "agent",
              entityId: agentName,
              resourceId
                ...
                if (startResult) {
                  if (startResult.proceed === false) {
                    ...
                    if (memory) {
                      try {
                        const userMessage = {
                          id: this.#mastra?.generateId() || crypto2.randomUUID(),
                          role: "user",
                          type: "text",
                          createdAt: /* @__PURE__ */ new Date(),
...
${effectiveInstructions}`;
            ...
            try {
              ...
              if ((methodType === "generate" || methodType === "generateLegacy") && supportedLanguageModelSpecifications.includes(modelVersion)) {
                const generateResult = resumeData ? await agent.resumeGenerate(resumeData, {
                  ...
                  requestContext,
                  ...chunk4UOWNFAL_cjs.resolveObservabilityContext(context ?? {}),
        ...
        convertedAgentTools[`agent-${agentName}`] = chunkQNXY3J6B_cjs.makeCoreTool(
          toolObj,
          options,
          void 0,
          autoResumeSuspendedTools
  ...
  async listWorkflowTools({
    ...
    if (Object.keys(workflows).length > 0) {
      for (const [workflowName, workflow] of Object.entries(workflows)) {
        ...
        const toolObj = chunkD6HO5QAM_cjs.createTool({
          ...
          execute: async (inputData, context) => {
            ...
            try {
              ...
              const runIdToUse = suspendedToolRunId || crypto2.randomUUID();
        ...
        convertedWorkflowTools[`workflow-${workflowName}`] = chunkQNXY3J6B_cjs.makeCoreTool(
          toolObj,
          options,
          void 0,
          autoResumeSuspendedTools
  ...
  async convertTools({
    ...
    if (this.#mastra) {
      mastraProxy = chunkQNXY3J6B_cjs.createMastraProxy({ mastra: this.#mastra, logger });
    }
  ...
  async prepareModels(requestContext, model) {
    if (model || !Array.isArray(this.model)) {
      ...
      let headers;
      if (resolvedModel instanceof chunkWU2P7XOU_cjs.ModelRouterLanguageModel) {
    ...
    const models = await Promise.all(
      this.model.map(async (modelConfig) => {
        ...
        let headers;
        if (model2 instanceof chunkWU2P7XOU_cjs.ModelRouterLanguageModel) {
  ...
  async #execute({ methodType, resumeContext, ...options }) {
    ...
    if ("structuredOutput" in options && options.structuredOutput?.schema) {
      ...
      if (targetProvider.includes("openai") || targetModelId.includes("openai")) {
        if (chunkQNXY3J6B_cjs.isZodType(options.structuredOutput.schema) && targetModelId) {
          const modelInfo = {
  ...
  async generate(messages, options) {
    ...
    const mergedOptions = chunkQNXY3J6B_cjs.deepMerge(
      defaultOptions,
      options ?? {}
    );
  ...
  async resumeStream(resumeData, streamOptions) {
    ...
    let mergedStreamOptions = chunkQNXY3J6B_cjs.deepMerge(
      defaultOptions,
      streamOptions ?? {}
    );
    const llm = await this.getLLM({
...
var LanguageDetector = class _LanguageDetector {
   ...
   */
  async detectLanguage(content, observabilityContext) {
    const prompt = this.createDetectionPrompt(content);
    try {
      const model = await this.detectionAgent.getModel();
      let response;
...
var SystemPromptScrubber = class {
   ...
   */
  async detectSystemPrompts(text, observabilityContext) {
    try {
      const model = await this.detectionAgent.getModel();
      let result;
...
var ToolSearchProcessor = class {
  ...
  constructor(options) {
    ...
    this.bm25Index = new chunk4P35AVPE_cjs.BM25Index({}, TOOL_SEARCH_TOKENIZE_OPTIONS);
    this.indexTools();
    if (this.ttl > 0) {
  ...
  async processInputStep(args) {
    ...
    const searchTool = chunkD6HO5QAM_cjs.createTool({
      id: "search_tools",
    ...
    const loadTool = chunkD6HO5QAM_cjs.createTool({
      id: "load_tool",
...
var SemanticRecall = class {
  ...
  formatCrossThreadMessages(messages, currentThreadId) {
    let result = ``;
    const v1Messages = new chunk3ZF7IC6Q_cjs.MessageList().add(messages, "memory").get.all.v1();
    let lastYmd = null;
...
https://mastra.ai/en/docs/memory/semantic-recall`
      ...
      if (typeof config.embedder === "string") {
        this.embedder = new chunkWU2P7XOU_cjs.ModelRouterEmbeddingModel(config.embedder);
      } else {
...
https://mastra.ai/en/docs/memory/overview`
  ...
  setEmbedder(embedder, embedderOptions) {
    if (typeof embedder === "string") {
      this.embedder = new chunkWU2P7XOU_cjs.ModelRouterEmbeddingModel(embedder);
    } else {
  ...
  getMergedThreadConfig(config) {
    ...
    const mergedConfig = chunkQNXY3J6B_cjs.deepMerge(this.threadConfig, config || {});
...
var MockMemory = class extends MastraMemory {
  constructor({
    ...
    super({
      name: "mock",
      storage: storage || new chunkZBESCKPX_cjs.InMemoryStore(),
      options: {
  ...
  listTools(_config) {
    ...
    return {
      updateWorkingMemory: chunkD6HO5QAM_cjs.createTool({
...
exports.formatStreamCompletionFeedback = formatStreamCompletionFeedback;
...
exports.runStreamCompletionScorers = runStreamCompletionScorers;
...
//# sourceMappingURL=chunk-YIJZBU54.cjs.map
//# sourceMappingURL=chunk-YIJZBU54.cjs.map