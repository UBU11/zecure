...
var chunkL3WDI7HP_cjs = require('./chunk-L3WDI7HP.cjs');
var chunkHAGCXIBX_cjs = require('./chunk-HAGCXIBX.cjs');
var chunkG5R2755Q_cjs = require('./chunk-G5R2755Q.cjs');
var chunkP6ZX7OKT_cjs = require('./chunk-P6ZX7OKT.cjs');
...
var Mastra = class {
  ...
  get datasets() {
    if (!this.#datasets) {
      this.#datasets = new chunkG5R2755Q_cjs.DatasetsManager(this);
    }
  ...
  constructor(config) {
    ...
    const workflowEventProcessor = new chunkL3WDI7HP_cjs.WorkflowEventProcessor({ mastra: this });
    ...
    if (storage) {
      storage = chunkYIJZBU54_cjs.augmentWithInit(storage);
    }
    if (config?.observability) {
      if (typeof config.observability.getDefaultInstance === "function") {
        ...
        this.#observability = new chunk4UOWNFAL_cjs.NoOpObservability();
      }
    } else {
      this.#observability = new chunk4UOWNFAL_cjs.NoOpObservability();
    }
    ...
    chunkMR7ZWBL6_cjs.registerHook("onScorerRun" /* ON_SCORER_RUN */, chunkP6ZX7OKT_cjs.createOnScorerHook(this));
  ...
  addAgent(agent, key, options) {
    ...
    let mastraAgent;
    if (chunkHAGCXIBX_cjs.isToolLoopAgentLike(agent)) {
      mastraAgent = chunkHAGCXIBX_cjs.toolLoopAgentToMastraAgent(agent, { fallbackName: key });
    } else {
      mastraAgent = agent;
    }
   ...
   */
  setStorage(storage) {
    this.#storage = chunkYIJZBU54_cjs.augmentWithInit(storage);
  }
  setLogger({ logger }) {
    this.#logger = logger;
    if (this.#agents) {
   ...
   */
  get loggerVNext() {
    return this.#observability.getDefaultInstance()?.getLoggerContext?.() ?? chunk4UOWNFAL_cjs.noOpLoggerContext;
  }
  /**
   ...
   */
  get metrics() {
    return this.#observability.getDefaultInstance()?.getMetricsContext?.() ?? chunk4UOWNFAL_cjs.noOpMetricsContext;
  }
  getServerMiddleware() {
  ...
  #syncGatewayRegistry() {
    try {
      ...
      import('./provider-registry-4HLP2JRR.cjs').then(async ({ GatewayRegistry }) => {
...
//# sourceMappingURL=chunk-V5YNS2QO.cjs.map
//# sourceMappingURL=chunk-V5YNS2QO.cjs.map