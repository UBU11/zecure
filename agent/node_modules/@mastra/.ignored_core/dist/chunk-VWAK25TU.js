import { executeWithContext, wrapMastra, createObservabilityContext } from './chunk-6JYMMRHB.js';
import { ToolStream } from './chunk-DD2VNRQM.js';
import { Tool, isVercelTool, validateToolInput, validateToolOutput, validateToolSuspendData } from './chunk-ZVWVQ6MG.js';
...
var CoreToolBuilder = class extends MastraBase {
  ...
  constructor(input) {
    ...
    if (!isVercelTool(this.originalTool) && (input.autoResumeSuspendedTools || this.originalTool.id?.startsWith("agent-") || this.originalTool.id?.startsWith("workflow-"))) {
...
//# sourceMappingURL=chunk-VWAK25TU.js.map
//# sourceMappingURL=chunk-VWAK25TU.js.map